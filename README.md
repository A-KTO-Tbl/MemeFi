...
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *выполняет все те же действия, что вы делали бы руками **([СКРИНШОТ](https://telegra.ph/file/ecd8151039b7a7832fc4f.png))**:*<br>**—** *Улучшение бустов ("Damage", "EnergyCap" и "EnergyRechargeRate")*;<br>**—** *Попытка апгрейда текущего босса*;<br>**—** *Если TapBot уже приобретен - происходит сбор монет и перезапуск бота каждые 3 часа*;<br>**—** *Если TapBot отсутствует - происходит его приобретение*;<br>**—** *Активация и фарм монет под бусты ("Turbo" и "Recharge")*;<br>**—** *6 часов беспрерывного тапания. 18 циклов по 20 минут*;<br>**—** *Повторение действий после 6 часов беспрерывного тапания*. |✅|
